                ...
                c => new
                    {
                        ...
                        IsSubscibedToNewsLetter = c.Boolean(nullable: false),
                        MembeshipTypeId = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MembeshipTypes", t => t.MembeshipTypeId, cascadeDelete: true)
                .Index(t => t.MembeshipTypeId);
